...
class PlaneCNN(ScriptedLoadableModule):
...
class PlaneCNNWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self):
        ...
        uiWidget = slicer.util.loadUI(self.resourcePath('UI/PlaneCNN.ui'))
